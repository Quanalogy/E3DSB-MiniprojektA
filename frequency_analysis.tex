...
\begin{figure}[htb]
	...
	\subcaptionbox{The original fft result vs smoothed result.\label{fig:car_smooth}}
	{\includegraphics[width=0.45\linewidth]{code/Car_figure3.png}}
	\subcaptionbox{The original fft result vs zero padded original.\label{fig:car_zero}}
	{\includegraphics[width=0.45\linewidth]{code/Car_figure4.png}}
	\subcaptionbox{The original fft result vs windowed original.\label{fig:car_window}}
...
\begin{figure}[htb]
	...
	\subcaptionbox{The original fft result vs smoothed result.\label{fig:windmill_smooth}}
	{\includegraphics[width=0.45\linewidth]{code/Windmill_figure3.png}}
	\subcaptionbox{The original fft result vs zero padded original.\label{fig:windmill_zero}}
	{\includegraphics[width=0.45\linewidth]{code/Windmill_figure4.png}}
	\subcaptionbox{The original fft result vs windowed original.\label{fig:windmill_window}}
